...
image_paths = sorted(glob('/Users/bmmorris/data/arcsat/20160708/KIC96*sdss_g*.fits'))#[:20]
...
master_flat_path = 'outputs/masterflat_20160708_g.fits'
master_dark_path = 'outputs/masterdark_20160708_g.fits'
...
star_positions = np.loadtxt('20160708_g.txt')

brightest_star_coords_init = np.array([186, 280])

output_path = 'outputs/20160708_g.npz'
