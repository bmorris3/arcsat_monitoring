...
image_paths = sorted(glob('/Users/bmmorris/data/arcsat/20160706/KIC965*sdss_g*.fits'))#[:20]
...
star_positions = np.loadtxt('/Users/bmmorris/Desktop/20160706.txt')

brightest_star_coords_init = np.array([186, 280])

output_path = 'outputs/20160706.npz'
...
np.savetxt('outputs/20160706.txt',
