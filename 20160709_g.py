...
image_paths = sorted(glob('/Users/bmmorris/data/arcsat/20160709/KIC965*sdss_g*.fits'))#[:20]
dark_30s_paths = glob('/Users/bmmorris/data/arcsat/20160708/Dark*.fits')
night_flat_paths = glob('/Users/bmmorris/data/arcsat/20160708/domeflat_sdss_g*.fits')
master_flat_path = 'outputs/masterflat_20160709.fits'
master_dark_path = 'outputs/masterdark_20160709.fits'
...
star_positions = np.loadtxt('/Users/bmmorris/Desktop/20160709.txt')

brightest_star_coords_init = np.array([186, 280])

output_path = 'outputs/20160709.npz'
