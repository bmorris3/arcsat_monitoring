...
image_paths = sorted(glob('/Users/bmmorris/data/arcsat/20160708/KIC96*sdss_u*.fits'))#[:20]
dark_30s_paths = glob('/Users/bmmorris/data/arcsat/20160708/Dark*.fits')
night_flat_paths = glob('/Users/bmmorris/data/arcsat/20160708/domeflat_sdss_u*.fits')
master_flat_path = 'outputs/masterflat_20160708_u.fits'
master_dark_path = 'outputs/masterdark_20160708_u.fits'
...
star_positions = np.loadtxt('/Users/bmmorris/Desktop/20160708_u.txt')

brightest_star_coords_init = np.array([186, 280])

output_path = 'outputs/20160708_u.npz'
