...
# image_paths = sorted(glob('/Users/bmmorris/data/arcsat/20160706/KIC*sdss_g*.fits'))#[:20]
# dark_30s_paths = glob('/Users/bmmorris/data/arcsat/20160706/Dark*.fits')
# night_flat_paths = glob('/Users/bmmorris/data/arcsat/20160706/domeflat_sdss_g*.fits')
# master_flat_path = 'outputs/masterflat_20160706.fits'
# master_dark_path = 'outputs/masterdark_20160706.fits'

image_paths = sorted(glob('/Users/bmmorris/data/arcsat/20160706/KIC*sdss_u*.fits'))#[:20]
dark_30s_paths = glob('/Users/bmmorris/data/arcsat/20160706/Dark*.fits')
night_flat_paths = glob('/Users/bmmorris/data/arcsat/20160706/domeflat_sdss_u*.fits')
master_flat_path = 'outputs/masterflat_20160706_u.fits'
master_dark_path = 'outputs/masterdark_20160706_u.fits'
...
star_positions = np.loadtxt('/Users/bmmorris/Desktop/20160706_u.txt')

brightest_star_coords_init = np.array([186, 280])

output_path = 'outputs/20160706_u.npz'
...
for i in range(phot_results.fluxes.shape[2]):
    ...
    # plt.plot(phot_results.times, phot_results.fluxes[:, 1:, i], '.', label=i)
plt.legend()
plt.show()
